...
* [ESPN](http://highscalability.com/blog/2013/11/4/espns-architecture-at-scale-operating-at-100000-duh-nuh-nuhs.html): Another awesome and thorough example, this time from the digital media industry.
* For more advanced examples, check out these posts on [Google](http://highscalability.com/google-architecture), [Youtube](http://highscalability.com/youtube-architecture), and [StackOverflow](http://highscalability.com/blog/2009/8/5/stack-overflow-architecture.html).
